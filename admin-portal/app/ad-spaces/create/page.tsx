  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        let errorMessage = result.error || 'Failed to create ad space';
        ...
        console.error('Create ad space error:', {
      ...
      <div className="bg-slate-900 border-b border-slate-700">
        <div className="container-app px-6 py-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Create Ad Space</h1>
              <p className="text-slate-400 mt-1">Add a new advertising space to the platform</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="e.g., Corporate Office Lobby Display"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 bg-slate-800 border border-slate-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Describe the ad space..."
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-800 border border-slate-700 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="e.g., Professionals, Families, Students"
              />
            </div>
